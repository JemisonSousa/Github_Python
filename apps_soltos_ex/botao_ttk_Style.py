...
# root = Tk()
# style = ttk.Style()
# button_1 = ttk.Button(root, text='click me', command=root.destroy)
# style.theme_use('alt')
# style.configure('TButton', font=('American typewriter', 14), background='#232323', foreground='white')
# style.map('TButton', background=[('active', 'green')]) #ff0000
# button_1.pack()
...
class App:
    def __init__(self):
        ...
        self.style.map('TButton', background=[('active', '#ff0000'), ('disabled', '#f0f0f0')])
        self.button_1.pack()
